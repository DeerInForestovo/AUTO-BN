...
def print_measures(auroc, aupr, fpr, method_name='Ours', recall_level=recall_level_default):
    print(method_name.ljust(8),end='')
    print('\tfpr95={:.2f}'.format(100 * fpr),end='')
    print('\tauroc={:.2f}'.format(100 * auroc),end='')
    print('\taupr={:.2f}'.format(100 * aupr),end='')
    print('')


def print_measures_with_std(aurocs, auprs, fprs, method_name='Ours', recall_level=recall_level_default):
    print('\t' + method_name)
    print(' FPR{:d}:\t\t{:.2f}\t+/- {:.2f}'.format(int(100 * recall_level), 100 * np.mean(fprs), 100 * np.std(fprs)),end='')
    print(' AUROC: \t\t{:.2f}\t+/- {:.2f}'.format(100 * np.mean(aurocs), 100 * np.std(aurocs)),end='')
    print(' AUPR:  \t\t{:.2f}\t+/- {:.2f}'.format(100 * np.mean(auprs), 100 * np.std(auprs)),end='')
    print('')
